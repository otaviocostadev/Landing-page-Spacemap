/*  Opens and closes the menu by clicking on the icon: hamburguer e x */
...
/* Change the header of the page when it scrolls */
const header = document.querySelector('#header')
const navHeight = header.offsetHeight

function changeHeaderWhenScroll() {
  if (window.scrollY >= navHeight) {
    // Scroll is greater than the height of the header
